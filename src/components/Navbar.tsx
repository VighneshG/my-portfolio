    ...
    <nav className="bg-black/5 backdrop-blur-lg border-b border-gray-700/90 text-white p-6 sticky top-0 z-50 shadow-md">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <ul className="hidden lg:flex space-x-6 text-xl">
          ...
          <li>
            <Link href="/skills" className="hover:text-gray-300 transition-colors duration-300">
              Skills
            </Link>
          </li>
          <li>
            <Link href="/projects" className="hover:text-gray-300 transition-colors duration-300">
              Projects
            </Link>
          </li>
          <li>
      ...
      {isOpen && (
        <motion.div
          ...
          className="lg:hidden bg-black/5 backdrop-blur-lg"
        >
