  ...
  return (
    <div className="bg-white shadow-md rounded-lg overflow-hidden p-4 mb-6">
      ...
      <div className="flex justify-between">
        {demoLink && (
          <Link href={demoLink} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
            Live Demo
          </Link>
        )}
        <Link href={repoLink} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
          GitHub Repo
        </Link>
      </div>
    </div>
